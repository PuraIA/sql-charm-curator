        ...
        <div className="space-y-12">
            ...
            {guide.sample && (
                <section>
                    ...
                    <p>{t('guideXmlBeforeAfterIntro')}</p>
                    <div className="not-prose grid gap-4 lg:grid-cols-2 my-8">
                        <CodePanel label={t('guidePrettyLabel')} code={guide.sample.input} tone="muted" />
                        <CodePanel label={t('guideCompactModeOnLabel')} code={guide.sample.output} tone="primary" />
                    </div>
            ...
            {guide.invalidExamples && (
                <section>
                    <h2 className="text-3xl font-bold mb-6">{t('guideNotWellFormedTitle')}</h2>
                    <p>{t('guideNotWellFormedIntro')}</p>
...
function RelatedXmlGuides({ current }: { current: string }) {
    ...
    return (
        <section>
            <h2 className="text-3xl font-bold mb-6">{t('guideOtherXmlToolsTitle')}</h2>
            ...
            <LinkedSentence i18nKey="guideXmlOutro" to="/xml" linkTextKey="guideGeneralXmlFormatterLink" />
        </section>
    );
}
