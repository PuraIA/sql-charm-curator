    ...
    return (
        <div className="space-y-12">
            ...
            <section>
                ...
                <p>{t('guideConverterBeforeAfterIntro')}</p>
            ...
            <section>
                <h2 className="text-3xl font-bold mb-6">{t('guideMappingTitle')}</h2>
...
function RelatedConverters({ current }: { current: string }) {
    ...
    return (
        <section>
            <h2 className="text-3xl font-bold mb-6">{t('guideOtherConversionsTitle')}</h2>
            ...
            <p className="mt-6">{t('guideConverterOutro')}</p>
        </section>
    );
}
